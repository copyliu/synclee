...
from synclee.registration import forms
from synclee.registration import signals
from synclee.registration.admin import RegistrationAdmin
from synclee.registration.backends import get_backend
from synclee.registration.backends.default import DefaultBackend
from synclee.registration.models import RegistrationProfile
...
class BackendRetrievalTests(TestCase):
    ...
    def test_get_backend(self):
        ...
        """
        self.failUnless(isinstance(get_backend('synclee.registration.backends.default.DefaultBackend'),
                                   DefaultBackend))
    ...
    def test_backend_error_invalid(self):
        ...
        self.assertRaises(ImproperlyConfigured, get_backend,
                          'synclee.registration.backends.doesnotexist.NonExistentBackend')
    ...
    def test_backend_attribute_error(self):
        ...
        """
        self.assertRaises(ImproperlyConfigured, get_backend,
                          'synclee.registration.backends.default.NonexistentBackend')
